...
protocol NewsSmallTableViewCellDelegate
{
    func onSelectProductImg(productDic : NSMutableDictionary)
}

class NewsSmallTableViewCell: UITableViewCell {
    ...
    var newsSmallTableViewCellDelegate : NewsSmallTableViewCellDelegate?
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String!)
    {
        ...
        if self.leftImgView == nil
        {
            ...
            let tapLeftImgViewRecognizer = UITapGestureRecognizer(target: self, action: #selector(NewsSmallTableViewCell.onLeftImgViewTapped))
        ...
        if self.rightImgView == nil
        {
            ...
            let tapRightImgViewRecognizer = UITapGestureRecognizer(target: self, action: #selector(NewsSmallTableViewCell.onRightImgViewTapped))
    ...
    func onLeftImgViewTapped()
    {
        ...
        {
            newsSmallTableViewCellDelegate?.onSelectProductImg(self._leftProductDic!)
        }
    }
    ...
    func onRightImgViewTapped()
    {
        ...
        {
            newsSmallTableViewCellDelegate?.onSelectProductImg(self._rightProductDic!)
        }
    }
